...
module.exports = {
    async register(req, res) {
        const { user, password, color, title } = req.body;
        ...
        const userExist = await connection('users').where('user', user).first();
    ...
    async login(req, res) {
        ...
        const response = await connection('users').where('user', user).first();
